...
def plot_noisy_images(sae_noisy_images, dae_noisy_images, sae_losses, dae_losses, neuron_groups, dataset):
    ...
    Matches the layout and formatting of visualize_noise_grid.
    ...
    for group_idx in range(num_groups):
        ...
        if group_idx == 0:
            axes[0, group_idx].set_ylabel("SAE", fontsize=12, rotation=0, labelpad=20, va='center')
            axes[1, group_idx].set_ylabel("DevAE", fontsize=12, rotation=0, labelpad=20, va='center')
