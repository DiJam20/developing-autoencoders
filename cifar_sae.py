...
def train_sae(save_path,n_layers,hidden_ls,n_epochs=10):
	...
	sae_optimizer = torch.optim.Adam(sae_model.parameters(), lr=0.001)
...
if __name__ == '__main__':
	...
	sae_path = os.path.join(base_dir, "sae")
	# dae_path = os.path.join(base_dir, "dae")
	...
	n_epochs = 100
	sae_model, sae_train_loss, sae_validation_loss = train_sae(sae_path,n_layers,hidden_ls,n_epochs)
	np.save(sae_path + '/hidden_ls.npy', hidden_ls)
