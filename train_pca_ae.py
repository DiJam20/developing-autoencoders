...
def main():
    ...
    parser.add_argument('--freeze_epochs', type=int, default=20, help='Number of epochs to freeze bottleneck')
    parser.add_argument('--save_dir', type=str, default='./aiii26/models/dev-ae',
    ...
    for run_i in range(args.num_train_runs):
        ...
        t_loss, v_loss = train_vali_all_epochs_with_bottleneck_freeze(
            model=pca_ae, 
